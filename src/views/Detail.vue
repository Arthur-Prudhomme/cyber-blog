<template>
  <div class="detail">
    <div class="text-box" >
        ...
        <div class="content" v-if="pageData" v-html="pageData.content"></div>
        <div v-else>
...
const pages = [
  { 
    ...
    `
        ...
        le montant s'élève à <strong>400 000 €</strong> pour la Ville et <strong>100 000 €</strong> pour l’Agglomération.
        <br><br>
